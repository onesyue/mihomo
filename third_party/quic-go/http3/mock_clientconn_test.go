...
// Source: github.com/metacubex/quic-go/http3 (interfaces: TestClientConnInterface)
//
// Generated by this command:
//
//	mockgen -typed -build_flags=-tags=gomock -mock_names=TestClientConnInterface=MockClientConn -package http3 -destination mock_clientconn_test.go github.com/metacubex/quic-go/http3 TestClientConnInterface
//
