...
The code is licensed under the MIT license. The logo and brand assets are excluded from the MIT license. See [assets/LICENSE.md](https://github.com/metacubex/quic-go/tree/master/assets/LICENSE.md) for the full usage policy and details.
